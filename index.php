...
if(isset($_POST['submit'])){
    ...
    if(empty($email) || empty($password) || empty($fname)|| empty($lname)){
        echo "<script>alert('You have to fill up all the fields.');</script>";
    }else{

        $sql = "INSERT INTO `tbl_user`(`id`, `fname`, `lname`, `email`, `password`, `created_at`) VALUES (NULL, '$fname','$lname', '$email','$encrypt_pass', current_timestamp() )"; 
...
<head>
    ...
    <!-- <style>
       .catid-1, .catid-2, .catid-5, .catid-6, .catid-3, .catid-4{ display: none; }
        .loadMore{ font-weight: 600; }
        .search-inner .fav-icon {
            margin-top: -45px;
        }
        .game-img .small{
            width: 40px;
                ...
                <div class="action-sec fix-padding-y pb-0">
                        <div class="row m-0">
                            ...
                            <div class="owl-carousel owl-theme">
                                <?php 
                                // $trending_games = "SELECT * FROM `tbl_games` WHERE `trend_value` >= '5' ORDER BY RAND() LIMIT 12";
                                ...
                                <div class="item game-<?php echo $trend_id ?>">
                                    <a href="<?php echo $dir.'/games/'.$fetch_trend['game_code'] ?>" target="_blank" onclick="increaseValue(<?php echo $trend_id ?>)">
                                        <div class="col-12 p-3">
                                            <div class="game-img">
                                                <img class="pic" src="<?php echo $dir.'/images/'.$fetch_trend['image'] ?>" alt="" >
                ...
                <div class="new-game-sec row m-0">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="game-area box-shadow my-3">
                            ...
                            <div class="row m-0">
                                <div class="col-3">
                                    <div class="game-img">
                                        <img class="br-6 small" src="<?php echo $dir.'/images/'.$fetch_desc_game['image']?>" alt="">
                                    </div>
                                </div>
                                <div class="col-5 p-0">
                                ...
                                <a target="_blank" href="<?php echo $dir.'/games/'.$fetch_desc_game['game_code']?>" onclick="increaseValue(<?php echo $fetch_desc_game['id'] ?>)"><button class="play-btn">play</button></a>
                                </div>
                            </div>
                            <?php }else  { ?>
                            ...
                            <!-- <div class="row m-0 mt-4">
                                <div class="col-3">
                                    <div class="game-img">
                                        <img class="br-6" src="assets/image/i-3.png" alt="">
                                    </div>
                                </div>
                                <div class="col-5 p-0">
                            ...
                            <div class="row m-0 mt-4">
                                <div class="col-3">
                                    <div class="game-img">
                                        <img class="br-6" src="assets/image/i-4.png" alt="">
                                    </div>
                                </div>
                                <div class="col-5 p-0">
                                    <div class="text-1">dead end</div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="game-area my-3 box-shadow">
                            <?php 
                            $sql_week = "SELECT * FROM `tbl_games` ORDER BY id DESC LIMIT 1";
                            $res_week = mysqli_query($conn, $sql_week);
                            $fetch_week = mysqli_fetch_assoc($res_week);
                            ?>
                            <div class="row m-0">
                                <div class="col-12">
                                    <div class="game-img">
                                        <img class="br-6" src="<?php echo $dir.'/images/'.$fetch_week['image'] ?>" alt="">
                                    </div>
                                </div>

                                <div class="col-4 ">
                                    <div class="game-img">
                                        <img class="br-6 game-og-week-img" src="<?php echo $dir.'/images/'.$fetch_week['image'] ?>" alt="">
                                    </div>
                                </div>
                                <div class="col-1 p-0"></div>
                                <div class="col-6 p-0 mt-2">
                                    <div class="text-1"><?php echo $fetch_week['name'] ?></div>
                                    <div class="text-2">Rating</div>
                                    <div class="text-2"><?php echo $fetch_week['plays'] ?> plays</div>
                                </div>
                                <div class="col-12  mt-4 mb-3">
                                    <a href="<?php echo $dir.'/games/'.$fetch_week['game_code'] ?>"><button class="game-of-week-play-btn">play</button></a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <?php 
                            ...
                            <div class="row m-0">
                                <div class="col-3">
                                    <div class="game-img">
                                        <img class="br-6 small" height="40" width="40" src="<?php echo $dir.'/images/'.$fetch_most_play['image'] ?>" alt="" >
                                    </div>
                                </div>
                                <div class="col-5 p-0">
                                ...
                                <div class="col-4 text-end mt-2">
                                <a target="_blank" href="<?php echo $dir.'/games/'.$fetch_most_play['game_code'] ?>" onclick="increaseValue(<?php echo $fetch_most_play['id'] ?>)"><button class="play-btn">play</button></a>
                                </div>
                            </div>
                            <?php }else{ ?>
                            <div class="row m-0 mt-4">
                                <div class="col-3">
                                    <div class="game-img">
                                        <img class="br-6" src="<?php echo $dir.'/images/'.$fetch_most_play['image'] ?>" alt="">
                                    </div>
                                </div>
                                <div class="col-5 p-0">
                                    <div class="text-1"><?php echo $fetch_most_play['name'] ?></div>
                            ...
                            <!-- <div class="row m-0 mt-4">
                                <div class="col-3">
                                    <div class="game-img">
                                        <img class="br-6" src="assets/image/i-2.png" alt="">
                                    </div>
                                </div>
                                <div class="col-5 p-0">
                                    <div class="text-1">dead end</div>
                            ...
                            <div class="row m-0 mt-4">
                                <div class="col-3">
                                    <div class="game-img">
                                        <img class="br-6" src="assets/image/i-1.png" alt="">
                                    </div>
                                </div>
                                <div class="col-5 p-0">
                                    <div class="text-1">dead end</div>
                    ...
                    <div class="col-lg-8 col-md-12">
                            ...
                            <div class="game-area my-3 box-shadow">
                            <?php 
                            $sql_month = "SELECT * FROM `tbl_games` ORDER BY id ASC LIMIT 1";
                            $res_month = mysqli_query($conn, $sql_month);
                            $fetch_month = mysqli_fetch_assoc($res_month);
                            ?>
                                <div class="row m-0">
                                    <div class="col-12">
                                        <div class="game-img">
                                            <img class="br-6" src="<?php echo $dir.'/images/'.$fetch_month['image'] ?>" alt="">
                                        </div>
                                    </div>

                                    <div class="col-4 ">
                                        <div class="game-img">
                                            <img class="br-6 game-og-week-img" src="<?php echo $dir.'/images/'.$fetch_month['image'] ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="col-1 p-0"></div>
                                    <div class="col-6 p-0 mt-2">
                                        <div class="text-11"><?php echo $fetch_month['name'] ?></div>
                                        <div class="text-22">Rating</div>
                                        <div class="text-22"><?php echo $fetch_month['plays'] ?> plays</div>
                                    </div>
                                    <div class="col-12  mt-4 mb-3">
                                        <a href="<?php echo $dir.'/games/'.$fetch_month['game_code'] ?>" target="_blank" ><button class="game-of-week-play-btn">play</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-3 d-none d-md-block">
                <div class="sidebar">
                    <div class="card box-shadow p-4">
                        ...
                        ?>
                        <!-- <div class="my-2"><button class="cat-btn" onclick="location.href='#arcade';"><i
                                    class="fas fa-ghost"></i>Arcade</button>
                        </div>
                        <div class="my-2"><button class="cat-btn" onclick="location.href='#puzzle';"><i
                                    class="fas fa-puzzle-piece"></i>puzzle & logic</button></div>
                        <div class="my-2"><button class="cat-btn" onclick="location.href='#sports';"><i
                                    class="fas fa-car"></i>sports &
                                racing</button></div>
                        <div class="my-2"><button class="cat-btn" onclick="location.href='#stratergy';"><i
                                    class="fas fa-chess-knight"></i>Stratergy</button></div>-->
                        <div class="my-2"><button class="cat-btn" onclick="location.href='#favourite';"><i
                                    class="fas fa-heart"></i>My favourite</button></div> 
                    </div>
                </div>
            </div>
                ...
                <div class="content">
                    ...
                    ?>
                        <div class="games-sec" id="<?php echo $cat_info['name'] ?>">
                            <div class="card box-shadow p-4">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="home" role="tabpanel"
                                            ...
                                            <?php                                       
                                                ...
                                                ?>
                                                <div class="col-lg-3 col-md-4 col-6 p-3 game-<?php echo $gm_id ?> catid-<?php echo $gm_cat?>" >
                                                    <a href="<?php echo $dir.'/games/'.$game_info['game_code'] ?>" target="_blank" onclick="increaseValue(<?php echo $gm_id ?>)">
                                                        <div class="game-img">
                                                            <img src="<?php echo $dir.'/images/'.$game_info['image'] ?>" alt="" >
                                                        <?php if($loign_user_id != ''){ ?>
                                ...
                                <?php if($num > 4){ ?> 
                                    <center><div class="col-lg-4"><a href="#" class="loadMore" id="loadMore-<?php echo $category_id?>" style="text-align: center;">View More</a></div></center>
                                <?php } ?>
                    ...
                    <div class="games-sec fix-padding-y" id="<?php echo $get_med_cat['name'] ?>">
                        <div class="card box-shadow p-4">
                               ...
                               <!--  <div class="col-5 ms-auto d-none d-md-block">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home2" role="tabpanel"
                                        ...
                                        ?>
                                            <div class="col-lg-3 col-md-4 col-6 p-3 game-<?php echo $gm_id ?> catid-<?php echo $gm_cat ?>">
                                                <a href="<?php echo $dir.'/games/'.$fetch_med_game['game_code'] ?>" target="_blank" onclick="increaseValue(<?php echo $gm_id ?>)">
                                                    <div class="game-img">
                                                        <img src="<?php echo $dir.'/images/'.$fetch_med_game['image'] ?>" alt="" >
                                                    <?php if($loign_user_id != ''){ ?>   
                            ...
                            <?php if($med_count > 4){ ?> 
                                <center><div class="col-lg-4"><a href="#" class="loadMore" id="loadMore-<?php echo $category_id?>" class="btn btn-success" style="text-align: center;">Load More</a></div></center>
                            <?php } ?>                            
                        </div>
                    </div>
                    <?php } ?>
                            ...
                            <div class="row m-0">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home2" role="tabpanel"
                                        aria-labelledby="home-tab2">
                                        <div class="row"> 
                                        <?php while($fetch_last_game = mysqli_fetch_array($res_last_games)){    
                                                $fav_game_active = 'no-active';
                                            ...
                                            ?>
                                            <div class="col-lg-3 col-md-4 col-6 p-3 game-<?php echo $gm_id ?> catid-<?php echo $gm_cat ?>">
                                                <a href="<?php echo $dir.'/games/'.$fetch_last_game['game_code'] ?>" target="_blank" onclick="increaseValue(<?php echo $gm_id ?>)">
                                                    <div class="game-img">
                                                        <img src="<?php echo $dir.'/images/'.$fetch_last_game['image'] ?>" alt="" >
                                                    <?php if($loign_user_id != ''){ ?>    
...
function increaseValue(game_id){
    var game_id = game_id;
    // alert("game_id :"+game_id);
    $.ajax({
        url: "ajax/add_trending.php",
        type: "POST",
        data: {
            action: 'add_trending',
            game_id : game_id
