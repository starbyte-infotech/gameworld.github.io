                ...
                <div class="row">
                        ...
                        <a href="approve.html">
                            <div class="card card-chart">
                                <div class="card-header">
                                    <h5 class="card-category">1 Account Request</h5>
                                    <h4 class="card-title" style="color: #2c2c2c;">Abba</h4>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="approve.html">
                            <div class="card card-chart">
                                <div class="card-header">
                                    <h5 class="card-category">2 Account Request</h5>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="approve.html">
                            <div class="card card-chart">
                                <div class="card-header">
                                    <h5 class="card-category">5 Account Request</h5>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="approve.html">
                            <div class="card card-chart">
                                <div class="card-header">
                                    <h5 class="card-category">4 Account Request</h5>
